<?php
    ...
    abstract class Profile
    {
        ...
        public function __construct(Adapter $db, $table, array $filters = array())
        {
            $this->_db = $db;
            $this->_table = $table;
        ...
        public function load()
        {
            ...
            $results = $this->_db->query($query, Adapter::QUERY_MODE_EXECUTE)->toArray();

            foreach ($results as $result) {
                $this->_properties[$result[$this->_keyField]] = array('value'  => $result[$this->_valueField],
